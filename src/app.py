...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for competitive soccer matches and improve team play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Build basketball skills through drills and scrimmages",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["elijah@mergington.edu", "sofia@mergington.edu"]
    }
}
